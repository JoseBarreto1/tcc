...
\begin{figure}[h!]
    ...
    \legend{Fonte: Adaptado de \cite[p. 16]{galimberti2018}.}
    \label{fig:bertillon}
    \centering
\end{figure}
...
\begin{itemize}
    ...
    recurso mais comumente usado em credenciais 
     ...
     \begin{figure}[h!]
        ...
        \legend{Fonte: Adaptado de \cite[p. 10]{boechat2008}.}
        \label{fig:digital}
        \centering
    \end{figure}
...
Segundo \citeonline[p. 31]{cavalcanti2005}, alterações estéticas, como cabelo e barba, uso de

...
%\include{./PreTexto/abreviaturas}%% Comente para remover este item
...
% \partapendices
% \input{./PosTexto/apendicea}%% Apêndice - Comente para remover este item
% \input{./PosTexto/apendiceb}%% Apêndice - Comente para remover este item
% \end{apendicesenv}

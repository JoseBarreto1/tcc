...
\evalboardmember{Marcio Rodrigues da Cunha}{Doutor}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Osmar Tormena Junior}{Doutor}{Universidade Tecnológica Federal do Paraná}
\evalboardmember{Eduardo Giometti Bertogna}{Doutor}{Universidade Tecnológica Federal do Paraná}
...
\PalavraChaveA{Biometria}%% Palavra-chave A
\PalavraChaveB{Processamento de imagem}%% Palavra-chave B
\PalavraChaveC{ESP32}%% Palavra-chave C
...
\KeywordA{Biometry}%% Keyword A
\KeywordB{Image processing}%% Keyword B
\KeywordC{ESP32}%% Keyword C

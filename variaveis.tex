...
\title{DESENVOLVIMENTO DE PROTÓTIPO PARA CONTROLE DE ACESSO UTILIZANDO RECONHECIMENTO FACIAL COM SBC E OPENCV} % Título do trabalho
\titleen{Development of a prototype for access control using facial recognition with sbc and opencv} % Título traduzido para inglês
...
\evalboardmember{Nome completo e por extenso do Membro 1}{Avaliador(a) 1}{UTFPR}
\evalboardmember{Nome completo e por extenso do Membro 2}{Avaliador(a) 2}{UTFPR}
\evalboardmember{Nome completo e por extenso do Membro 3}{Avaliador(a) 3}{UTFPR}
...
\PalavraChaveC{OpenCV}%% Palavra-chave C
